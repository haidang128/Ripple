  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.subtitle}>Your ripple is waiting for you.</Text>

        {/* Divider placeholder keeps spacing consistent */}
        <View style={styles.divider}>
          <View style={styles.dividerLine} />
          <Text style={styles.dividerLabel}>sign in</Text>
          <View style={styles.dividerLine} />
        </View>
        ...
        <View style={styles.signupRow}>
          <Text style={styles.signupText}>New to Ripple?{' '}</Text>
